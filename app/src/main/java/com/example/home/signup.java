...
public class signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_name = findViewById(R.id.group_3);
        et_email = findViewById(R.id.group_4);
        et_password = findViewById(R.id.group_6);
        et_conf_pass = findViewById(R.id.group_9);

        btn_signup = findViewById(R.id.group_10);
        ...
        btn_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(S_et_name)){
                    ...
                    Toast.makeText(signup.this,"Don't forget to confirm your password !",Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(signup.this,"Enter the the same password.",Toast.LENGTH_LONG).show();
    ...
    public void register(String name,String email,String passwaord,String cf_pass){
        ...
        auth.createUserWithEmailAndPassword(email,passwaord).addOnCompleteListener(signup.this, new OnCompleteListener<AuthResult>() {
            @Override
...
//
//                            if(task.isSuccessful()){
//                                Toast.makeText(signup.this,"Registered successfully in firsebase",Toast.LENGTH_LONG).show();
//
//
...
//                            }
//                            else {
//                                Toast.makeText(signup.this,"Registered failed in firsebase",Toast.LENGTH_LONG).show();
//                            }
//
//                        }
//                    });
